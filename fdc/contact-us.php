          ...
          <a href="disaster-recovery-backup.html">Disaster Recovery </a>
                    ...
                    <div class="rts-header__right" >
                        <div class="button-area">
                            ...
                            <a href="contact-us.html" class="get-started__btn" style="text-transform: uppercase;">Get in Touch </a>
        ...
        <div class="container">
          ...
          <div class="col-12 d-flex justify-content-center">
                    <div class="text-center">
                       ...
                       <p data-sal="slide-down" data-sal-delay="800" data-sal-duration="800" class="w-790" style="color:#000;margin: auto;" >For inquiries, consultations, or partnerships, reach out to us at:
</p><br />
            ...
            <div class="row g-30">
                <div class="col-lg-4 col-md-6 col-sm-6 sal-animate" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                    <div class="cloud-feature">
                        <div class="icon">
                         
                        </div>
                        <h4 class="title">  <i class="fa-solid fa-location-dot" ></i> &nbsp;Fortune Data Centre</h4>
                        <p class="description">
                            Vardhman Polytex Limited, Phase -8
Chandigarh road, Ludhiana Punjab - 141123, India
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 sal-animate" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                    <div class="cloud-feature">
                        ...
                        <h4 class="title">     <i class="fa-solid fa-phone"></i> &nbsp;&nbsp;Phone</h4>
                        <p class="description">
                            0161-4060200 (Sales)

                        </p>
                        <p class="description">
                            0161-4060300 (Consultation)

                        </p>
                        <p class="description">
                            +91 95011 18812 (Support)
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 sal-animate" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                    <div class="cloud-feature">
                        ...
                        <h4 class="title">     <i class="fa-solid fa-envelope"></i>&nbsp;&nbsp;Email</h4>
                        <p class="description">
                           <a href="mailto:admin@fortunedatacentres.com;">admin@fortunedatacentres.com</a>
                           <a href="mailto:admin@fortunedatacentres.com;">sales@fortunedatacentres.com</a>
                           <a href="mailto:admin@fortunedatacentres.com;">support@fortunedatacentres.com</a>
                        </p>
                    </div>
                </div>
